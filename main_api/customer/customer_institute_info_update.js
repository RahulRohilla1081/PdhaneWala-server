...
/*   
API url: - 
http://localhost:9000/main_api/customer/customer_institute_info_update
payload:-
{
    "USER_ID":"PWC0000001",
    "INSTITUTE_NAME":"Coaching centre",
    "INSTITUTE_ADDRESS":"abcd xyz",
    "INSTITUTE_LOGO":image from UI
}
*/
...
router.post("/", async function (req, res, next) {
  try {
    ...
    let updateData = {
      ...
      LOGO_URL: SERVER_URL + "institute_logo_" + formData.USER_ID + ".png",
    };
    ...
    if (req.files) {
      ...
      INSTITUTE_LOGO.mv(
        path.join(
          __dirname +
            "../../../assets/customer_institute/institute_logo_" +
            formData.USER_ID +
            ".png"
        )
      );
